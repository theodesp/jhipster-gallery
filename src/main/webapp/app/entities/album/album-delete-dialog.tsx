...
export const AlbumDeleteDialog = (props: IAlbumDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhgalleryApp.album.delete.question">
        <Translate contentKey="jhgalleryApp.album.delete.question" interpolate={{ id: albumEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-album" color="danger" onClick={confirmDelete}>
