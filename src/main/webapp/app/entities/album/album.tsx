...
export const Album = (props: IAlbumProps) => {
  ...
  const { albumList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="album-heading">
        <Translate contentKey="jhgalleryApp.album.home.title">Albums</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhgalleryApp.album.home.createLabel">Create new Album</Translate>
        </Link>
      </h2>
        ...
        {albumList && albumList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="jhgalleryApp.album.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="jhgalleryApp.album.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('created')}>
                  <Translate contentKey="jhgalleryApp.album.created">Created</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhgalleryApp.album.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhgalleryApp.album.home.notFound">No Albums found</Translate>
            </div>
          )
        )}
      </div>
