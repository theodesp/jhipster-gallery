...
import com.thdespou.jhgallery.domain.Album;
import com.thdespou.jhgallery.repository.AlbumRepository;
...
/**
 * REST controller for managing {@link com.thdespou.jhgallery.domain.Album}.
 */
@RestController
@RequestMapping("/api")
@Transactional
